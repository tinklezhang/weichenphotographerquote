...
- The quote form offers Event Photography, Commercial Photography, Family Photography, Portrait Photography, and Documentary Photography.
- Each category exposes only the subtypes documented for the current Studio service structure.
- Included-photo wording and quote output match the selected category: 40–50/hour for Event and Commercial, 20+/hour for Family, package-based for Portrait, and scope-based for Documentary.
...
- Replaced the flat legacy type list with five service categories and category-specific photography types in English, Chinese, and Filipino modes.
